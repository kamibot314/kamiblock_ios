...
public class StagePart extends UIPart {
	...
	private const readoutLabelFormat:TextFormat = new TextFormat(CSS.font, 14, CSS.textColor, true);
...
//	private var stopButton:IconButton;
	...
	public function StagePart(app:Main) {
		this.app = app;
		outline = new Shape();
		addChild(outline);
		addTitleAndInfo();
...
//		projectTitle.setWidth(runButton.x - projectTitle.x - 15);
	...
	private function addTitleAndInfo():void {
		...
		versionInfo = makeLabel(Main.versionString, versionFormat);
	...
	private function addTurboIndicator():void {
		...
		turboIndicator.mouseEnabled = false;
...
//	}
	...
	public function showFullScreenButton():void{
		if(fullscreenButton.parent==null){
...
*/
	public function addUserNameWarning():void {
		...
		userNameWarning.mouseEnabled = false;
		userNameWarning.mouseChildren = false;
