...
public class SoundPrims {
	...
	public function SoundPrims(app:Main, interpreter:Interpreter) {
		this.app = app;
	...
	public function addPrimsTo(primTable:Dictionary):void {
		...
		//2017/04/20 이승훈 추가
		primTable["recording1"]				= primRecording1;
		primTable["recording2"]				= primRecording2;
		primTable["recording3"]				= primRecording3;
		primTable["recording4"]				= primRecording4;
		primTable["recording5"]				= primRecording5;
	...
	private function primPlaySound(b:Block):void {
		...
		if(Translator.map("recording1")==interp.arg(b, 0)){
			soundName = "recording1";
		}else if(Translator.map("recording2")==interp.arg(b, 0)){
			soundName = "recording2";
		}else if(Translator.map("recording3")==interp.arg(b, 0)){
			soundName = "recording3";
		}else if(Translator.map("recording4")==interp.arg(b, 0)){
			soundName = "recording4";
		}else if(Translator.map("recording5")==interp.arg(b, 0)){
			soundName = "recording5";
		}else{
			soundName = interp.arg(b, 0);
		}
		trace("soundName : "+soundName);
		var snd:ScratchSound = interp.targetObj().findSound(soundName);
	...
	//2017/04/20 이승훈 추가
	private function primRecording1(b:Block):String {
		var s:ScratchSound = interp.targetObj().sounds[1];
		return (s != null) ? "recording1" : "";
	}
	private function primRecording2(b:Block):String {
		var s:ScratchSound = interp.targetObj().sounds[2];
		return (s != null) ? "recording2" : "";
	}
	private function primRecording3(b:Block):String {
		var s:ScratchSound = interp.targetObj().sounds[3];
		return (s != null) ? "recording3" : "";
	}
	private function primRecording4(b:Block):String {
		var s:ScratchSound = interp.targetObj().sounds[4];
		return (s != null) ? "recording4" : "";
	}
	private function primRecording5(b:Block):String {
		var s:ScratchSound = interp.targetObj().sounds[5];
		return (s != null) ? "recording5" : "";
	}
